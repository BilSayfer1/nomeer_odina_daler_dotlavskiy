...
function reload(arr, place) {
    ...
    for (let itm of arr) {
        ...
        let box = createBox("./img/dollar.svg", itm.price);
        let boxTwo = createBox("./img/star.svg", itm.rating.rate);
        let boxTr = createBox("./img/square.png", itm.rating.count);
...
let openSidebarButton = document.querySelector("#openSidebarButton")
let closeSidebarButton = document.querySelector("#closeSidebarButton")
